...
> No because there is too much seasonality and it is not a good predictor of discharge on any given day.
...
> Data without seasonality or cycles, taking data from same day/month/season over time, annual means. 
...
table(diff(ClearCreekDischarge$Date)) #check to see if any dates are missing.  One is missing, can ignore it
