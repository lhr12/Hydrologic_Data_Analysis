...
-axis labels
-legible font sizes
-legible data point sizes (large or small enough)
-appropriate graph type
-interactive (if digital)
...
<We would like to visualize water quality data, which could be numerical, categorical, or done in a time series.>
...
<I would test different ones to see which graph I thought was most appropriate, or ask a friend.> 
...
<boxplots cannot show sample size; spaghetti plots are confusing to read; >
...
class(EnoDischarge$Date)

rollmean(EnoDischarge$Discharge2, 30)
