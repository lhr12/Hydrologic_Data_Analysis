...
Body of water of a certain size, low enough threshold of inputs/outputs
landlocked, within a depression, cannot be connected to ocean (would be an estuary)
light does not penetrate to bottom of a lake
possible volume/flow ratio
What are the physical properties of lakes?
differentiation between wetland and lake possibly depth/temperature/ecology
lentic system: still water
## Session Set Up
```{r, message = FALSE}
...
I learned why and how lakes mix in the spring and fall, and why they stratify in the summer. 
