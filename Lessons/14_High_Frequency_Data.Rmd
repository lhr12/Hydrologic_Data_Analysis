...
>chemostatic: chemical concentrations to do not change with discharge. Crane creek is more chemostatic
...
>diluting: concentration goes down with increased flow. Flushing: as flow increases, concentration increases.
hysteresis: behavior is different at the beginning and the end of an event (different sources from quickflow vs. baseflow).
...
>how much energy is being consumed/produced and at what rate; GPP (produces carbon and oxygen), Ecosystem Respiration (ER) (consumes oxygen, respires co2)
...
>productivity, respiration, dispersion
